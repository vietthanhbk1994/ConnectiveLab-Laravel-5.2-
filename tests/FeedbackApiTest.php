...
class FeedbackApiTest extends TestCase
{
    ...
    public function testCreateFeedback()
    {
        ...
        $this->json('POST', '/api/v1/feedbacks', $feedback);
    ...
    public function testReadFeedback()
    {
        ...
        $this->json('GET', '/api/v1/feedbacks/'.$feedback->id);
    ...
    public function testUpdateFeedback()
    {
        ...
        $this->json('PUT', '/api/v1/feedbacks/'.$feedback->id, $editedFeedback);
    ...
    {
        $feedback = $this->makeFeedback();
        $this->json('DELETE', '/api/v1/feedbacks/'.$feedback->id);
