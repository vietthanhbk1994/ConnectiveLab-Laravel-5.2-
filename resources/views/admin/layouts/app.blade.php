...
<html>
    ...
    <body class="skin-blue sidebar-mini">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                     ...
                                     * DATE: 08/08/2016
                                     * CONTENT: Hien thi anh dai dien no-image
                                     * ----------------------------
                                     */-->
                                    @if (Auth::user()->avatar=="")
        ...
        @yield('scripts')
        <script src="{{ URL::to('/back/js/js.js') }}"></script>
        <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/js/select2.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/iCheck/1.0.2/icheck.min.js"></script>
        <!--icon website tab-->
        <link rel="shortcut icon" href="images/favicon_2.ico" type="image/icon">
        <link rel="icon" href="images/favicon_2.ico" type="image/icon">

        <!-- AdminLTE App -->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.3/js/app.min.js"></script>
        <script src="{{ URL::to('/lib/dist/sweetalert.min.js') }}"></script>
         <!-- ckeditor-->
        <script type="text/javascript" src="{{ URL::to('/lib/ckeditor/ckeditor.js') }}"></script>
        @stack('end-scripts')
    </body>
</html>